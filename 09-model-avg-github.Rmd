...
In this exercise, you will practice using GitHub. 

1. Log in to your GitHub account. Go to <url>, and fork the repository
...
Aside from \texttt{ses\_cm} and \texttt{ses\_cmc}, ______ are the most important for predicting \texttt{mAch}, while _____ is the least important?
